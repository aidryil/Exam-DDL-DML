...
INSERT INTO team(name, trainer) VALUES 
    ...
    ('Seguros Amaya','Mínguez'),
    ('Telecom','Morgan Reikcard'),
    ('TVM','Steveens Henk'),
    ('Wordperfect','Bill Gates');
INSERT INTO cyclist(number, name, age, team) VALUES 
    ...
    (62,'Raúl Alcalá',30,'Motorola'),
    (63,'Álvaro Mejía',32,'Motorola'),
    ...
    (68,'Ángel Citracca',28,'Navigare'),
    (69,'Eddy Seigneur',27,'Castorama'),
    (70,'Sandro Heulot',29,'Banesto'),
    (71,'Prudencio Indurain',27,'Banesto'),
    ...
    (77,'Javier Mauleón',33,'Mapei-Clas'),
...
INSERT INTO stage(id, km, departure, arrival, win_cyclist) VALUES 
    (1,9,'Valladolid','Valladolid',1),
    (2,180,'Valladolid','Salamanca',36),
    (3,240,'Salamanca','Cáceres',12),
    ...
    (17,140,'Cangas de Onís','Alto del Naranco',4),
    (18,195,'Ávila','Ávila',8),
    (19,190,'Ávila','Destilerías Dyc',2),
    (20,52,'Segovia','Destilerías Dyc',2),
    (21,170,'Destilerías Dyc','Madrid',27);

INSERT INTO jersey(id, type, color, prize)  VALUES 
    ('MGE','General','Amarillo',8000000),
    ('MMO','Montaña','Blanco y rojo',2000000),
    ('MMS','Más sufrido','Estrellitas moradas',2000000),
    ('MMV','Metas volantes','Rojo',2000000),
    ('MRE','Regularidad','Verde',2000000),
    ('MSE','Sprints especiales','Rosa',2000000);

INSERT INTO climb(name, height, category, slope, stage, win_cyclist) VALUES 
    ('Alto del Naranco',565,'1',6.90,10,30),
    ('Arcalís',2230,'E',6.50,10,4),
...
INSERT INTO wears(cyclist, stage, jersey) VALUES 
    (1,1,'MGE'),
    (1,1,'MMO'),
    (67,1,'MMS'),
    (1,1,'MMV'),
